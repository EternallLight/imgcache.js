...
(function ($) {
  ...
  Helpers.EntryToURL = function(entry) {
    ...
    // Fixed this to support WkWebView.
    else if (window.Ionic && window.Ionic.WebView && typeof window.Ionic.WebView.convertFileSrc === 'function') {
      return window.Ionic.WebView.convertFileSrc(entry.toURL());
    }
